#If you find a job related with Karate framework, you can mention about this feature
Feature: Karate Java Integration

  Background:
    * def spartanUrl = 'http://34.201.62.210:8000'
  ...
  Scenario: Create a new spartan
    ...
    And request
    #request is for sending the body for POST methods
    """
    {
       "gender": "Female",
       "name": "Lorenza",
